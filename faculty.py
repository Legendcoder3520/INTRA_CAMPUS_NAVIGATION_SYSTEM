class dlist:
    ...
    def insertfirst(self, e):
        ...
        if self.size == 0:
            ...
            self.head = newnode
        self.size += 1
        print(f"Added {e} to the first position. Current size: {self.size}")
    ...
    def insertlast(self, e):
        ...
        if self.size == 0:
            ...
            self.tail = newnode
        self.size += 1
        print(f"Added {e} to the last position. Current size: {self.size}")
    ...
    def insert_at_position(self, e, position):
        ...
        if current.element is None:
            ...
            if newnode.next is None:
                self.tail = newnode
            self.size += 1
        print(f"Added {e} at position {position}. Current size: {self.size}")
    ...
    def printlist(self):
        if self.size == 0:
            ...
            current = self.head
            while current:
                print(current.element if current.element else "None", end=" ")
                current = current.next
            print()
        ...
        if position == "first":
            ...
            try:
                ...
                if current is not None and current.element is None:
                    ...
                    self.size += 1
                    print(f"Added {name} at position {position_index}. Current size: {self.size}")
                else:
